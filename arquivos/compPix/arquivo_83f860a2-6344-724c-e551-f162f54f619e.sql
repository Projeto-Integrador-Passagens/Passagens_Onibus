...
INSERT INTO `passagens` (`id`, `viagens_id`, `usuarios_id`, `comentario`, `avaliacao`, `nome`, `cpf`, `data_venda`, `status`, `compPix`, `valor`) VALUES
(1, 1, 2, NULL, NULL, 'Matheus Cardoso', '12412193975', '2025-02-04', 'EM ANDAMENTO', 'arquivo_1d92a89f-65ae-de58-e15a-d1f84be52fe4.jfif', 40),
(2, 1, 2, NULL, NULL, 'Matheus Cardoso', '12412193975', '2025-02-04', 'EM ANDAMENTO', 'arquivo_c3b36f16-b4cd-52ca-04b6-603ede203161.webp', 40);
