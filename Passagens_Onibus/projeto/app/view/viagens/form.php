            ...
            <div class="form-right">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="txtSituacao" name="situacao">
                        <option value="PROGRAMADA" <?php echo (isset($dados["viagem"]) && $dados["viagem"]->getSituacao() == "PROGRAMADA" ? 'selected' : ''); ?>>Programada</option>
                        <option value="FINALIZADA" <?php echo (isset($dados["viagem"]) && $dados["viagem"]->getSituacao() == "FINALIZADA" ? 'selected' : ''); ?>>Finalizada</option>
                    </select>
                </div>
            </div>
