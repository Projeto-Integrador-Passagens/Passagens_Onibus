...
class ViagensDAO {
  ...
  public function listByUsuario($idUsuario) {
    ...
    public function cadastrarViagem(Viagens $viagens) {
        ...
        $sql = "INSERT INTO viagens (data_horario, cidade_origem, cidade_destino, preco, total_passagens, situacao)" .
               " VALUES (:data_horario, :cidade_origem, :cidade_destino, :preco, :total_passagens, :situacao)";
